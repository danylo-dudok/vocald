...
# MLX whisper loads the original OpenAI weights — the registry-level
# WHISPER_HF_REPOS now points at CTranslate2 conversions (faster-whisper),
# which MLX cannot read.
WHISPER_HF_REPOS = {
