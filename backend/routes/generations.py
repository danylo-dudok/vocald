...
def _resolve_generation_engine(data: models.GenerationRequest, profile) -> str:
    return data.engine or getattr(profile, "default_engine", None) or getattr(profile, "preset_engine", None) or "kokoro"
...
async def generate_speech(
    ...
    if data.personality and getattr(profile, "personality", None):
        try:
            ...
            # Torch-free slim build: LLM backend raises a clear message
