...
@router.get("/")
async def root():
    """Root endpoint — headless build, JSON only."""
...
async def health():
    ...
    try:
        ...
        default_config = get_model_config("kokoro")
        default_model_id = default_config.hf_repo_id if default_config else "hexgrad/Kokoro-82M"
