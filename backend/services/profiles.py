...
# No cloning engines ship in the slim headless image — kokoro is preset-only.
# Cloned profiles can still be created and hold samples; generating with one
# fails validation until a cloning engine is reinstated.
CLONING_ENGINES: set[str] = set()
